...
from eye_tracking.analysis.lib.pupil.pupil_src.shared_modules import accuracy_visualizer
...
try:
    from eye_tracking.analysis.lib.pupil.pupil_src.shared_modules.video_capture import init_playback_source
...
def nbp_pupildetect(eye_id=None, folder=None, pupildetect_options=None, detector_type='2d'):
    from eye_tracking.analysis.code.functions.pl_surface import fake_gpool_surface
    from eye_tracking.analysis.lib.pupil.pupil_src.shared_modules.ui_roi import UIRoi
    ...
    if pupildetect_options:
        ...
        for key in pupildetect_options.keys():
