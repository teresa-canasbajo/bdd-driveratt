...
eigen3_path = '../../../../../../local/build/eigen3'
ceres_path = '../../../../../../local/build/build_ceres/include'
opencv_path = '../../../../../../local/build/build_opencv/include/opencv'
opencv2_path = '../../../../../../local/build/build_opencv/include'
if platform.system() == 'Windows':
    ...
    ceres_library_dir = '../../../../../../local/build/build_ceres/lib'
    import ctypes
    ctypes.cdll.LoadLibrary(
        ceres_library_dir + '/libceres.so.2')
    ...
    if(not os.path.isfile(opencv_library_dir+'/libopencv_core.so')):
        ...
        for ros_dist in ros_dists:
            ...
            if(os.path.isfile(ros_candidate_path+'/libopencv_core3.so')):
                ...
                break
    include_dirs = [np.get_include(), opencv2_path, opencv_path, ceres_path, eigen3_path, shared_cpp_include_path, singleeyefitter_include_path, opencv_include_dir]
    ...
    xtra_obj = []
    library_dirs = [opencv_library_dir, ceres_library_dir]
