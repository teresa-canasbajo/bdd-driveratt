...
if len(logger.handlers) != 2:
    ...
    # create handlers
    logfile = os.path.join('/home/whitney/Teresa/etcomp/log_files', str('temp_' + time.strftime("%Y_%m_%d-%H-%M-%S") + '.log'))
    
    # final logfile name
    logfile = os.path.join('/home/whitney/Teresa/etcomp/log_files', str('log_preprocess_' + time.strftime("%Y_%m_%d-%H-%M-%S") + '.log'))
