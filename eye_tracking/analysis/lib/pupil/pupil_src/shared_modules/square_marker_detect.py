...
#                                    method=cv2.CHAIN_APPROX_SIMPLE,offset=(0,0)) #TC89_KCOS
    ...
    # also we want all contours to be counter clockwise oriented, we use  it in the end...
    #     # also we want all contours to be counter clockwise oriented,convex hull fot this:
